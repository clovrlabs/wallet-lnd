...
type config struct {
	...
	KeepChannelsWithPendingPayments bool          `long:"keep-channels-with-pending-payments" description:"If true, then channels with outgoing htlcs that have timed-out and are a result of this node initiated payments will not be force closed."`

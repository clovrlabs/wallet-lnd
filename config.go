...
const (
	...
	defaultKeepChannelsWithPendingPayments = false
...
type config struct {
	...
	KeepChannelsWithPendingPayments bool          `long:"keep-channels-with-pending-payments" description:"If true, then channels with outgoing htlcs that have time-outed and are a result of this node initiated payments will not be forced closed."`
...
func loadConfig() (*config, error) {
	defaultCfg := config{
		...
		KeepChannelsWithPendingPayments: defaultKeepChannelsWithPendingPayments,

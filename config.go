...
const (
	...
	defaultPaymentsExpirationGracePriod = time.Duration(0)
...
type config struct {
	...
	PaymentsExpirationGracePriod time.Duration `long:"payments-expiration-grace-period" description:"A period to wait before force closing channels with outgoing htlcs that have timed-out and are a result of this node initiated payments."`
...
func loadConfig() (*config, error) {
	defaultCfg := config{
		...
		PaymentsExpirationGracePriod: defaultPaymentsExpirationGracePriod,

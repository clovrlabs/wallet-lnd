...
// UnimplementedBreezBackuperServer can be embedded to have forward compatible implementations.
type UnimplementedBreezBackuperServer struct {
}

func (*UnimplementedBreezBackuperServer) GetBackup(ctx context.Context, req *GetBackupRequest) (*GetBackupResponse, error) {

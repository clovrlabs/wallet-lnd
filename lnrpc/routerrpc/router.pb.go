...
type CircuitKey struct {
	/// The id of the channel that the htlc arrived at our node on.
	IncomingChanId uint64 `protobuf:"varint,1,opt,name=incoming_chan_id,json=incomingChanId,proto3" json:"incoming_chan_id,omitempty"`
...
func (m *CircuitKey) GetIncomingChanId() uint64 {
	if m != nil {
		return m.IncomingChanId
	}
	return 0
}
...
func (m *ForwardHtlcInterceptRequest) GetCircuitKey() *CircuitKey {
	if m != nil {
		return m.CircuitKey
	}
	return nil
...
func (m *ForwardHtlcInterceptRequest) GetAmountSat() uint64 {
	if m != nil {
		return m.AmountSat
	}
	return 0
...
type ForwardHtlcInterceptResponse struct {
	...
	CircuitKey *CircuitKey `protobuf:"bytes,1,opt,name=circuit_key,json=circuitKey,proto3" json:"circuit_key,omitempty"`
	//*
	//Indicates whether this forwarded htlc should be intercepted or keep the default
	//behavior.
...
func (m *ForwardHtlcInterceptResponse) GetCircuitKey() *CircuitKey {
	if m != nil {
		return m.CircuitKey
	}
	return nil
...
func (m *ForwardHtlcInterceptResponse) GetHold() bool {
	if m != nil {
		return m.Hold
	}
	return false
...
type ResolveHoldForwardRequest struct {
	//*
	//The key of this forwarded htlc. It defines the incoming channel id and
	//the index in this channel.
	CircuitKey *CircuitKey `protobuf:"bytes,1,opt,name=circuit_key,json=circuitKey,proto3" json:"circuit_key,omitempty"`
...
func (m *ResolveHoldForwardRequest) Reset()         { *m = ResolveHoldForwardRequest{} }
func (m *ResolveHoldForwardRequest) String() string { return proto.CompactTextString(m) }
func (*ResolveHoldForwardRequest) ProtoMessage()    {}
func (*ResolveHoldForwardRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7a0613f69d37b0a5, []int{27}
}

func (m *ResolveHoldForwardRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ResolveHoldForwardRequest.Unmarshal(m, b)
}
func (m *ResolveHoldForwardRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ResolveHoldForwardRequest.Marshal(b, m, deterministic)
}
func (m *ResolveHoldForwardRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResolveHoldForwardRequest.Merge(m, src)
}
func (m *ResolveHoldForwardRequest) XXX_Size() int {
	return xxx_messageInfo_ResolveHoldForwardRequest.Size(m)
}
func (m *ResolveHoldForwardRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ResolveHoldForwardRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ResolveHoldForwardRequest proto.InternalMessageInfo

func (m *ResolveHoldForwardRequest) GetCircuitKey() *CircuitKey {
	if m != nil {
		return m.CircuitKey
	}
	return nil
...
func (m *ResolveHoldForwardRequest) GetAction() ResolveHoldForwardAction {
	if m != nil {
		return m.Action
	}
...
func (m *ResolveHoldForwardRequest) GetRPreimage() []byte {
	if m != nil {
		return m.RPreimage
	}
	return nil
...
type ResolveHoldForwardResponse struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ResolveHoldForwardResponse) Reset()         { *m = ResolveHoldForwardResponse{} }
func (m *ResolveHoldForwardResponse) String() string { return proto.CompactTextString(m) }
func (*ResolveHoldForwardResponse) ProtoMessage()    {}
func (*ResolveHoldForwardResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7a0613f69d37b0a5, []int{28}
}

func (m *ResolveHoldForwardResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ResolveHoldForwardResponse.Unmarshal(m, b)
}
func (m *ResolveHoldForwardResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ResolveHoldForwardResponse.Marshal(b, m, deterministic)
}
func (m *ResolveHoldForwardResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResolveHoldForwardResponse.Merge(m, src)
}
func (m *ResolveHoldForwardResponse) XXX_Size() int {
	return xxx_messageInfo_ResolveHoldForwardResponse.Size(m)
}
func (m *ResolveHoldForwardResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ResolveHoldForwardResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ResolveHoldForwardResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ResolveHoldForwardRequest)(nil), "routerrpc.ResolveHoldForwardRequest")
	proto.RegisterType((*ResolveHoldForwardResponse)(nil), "routerrpc.ResolveHoldForwardResponse")
}
...
var fileDescriptor_7a0613f69d37b0a5 = []byte{
	...
	,
}
...
type RouterClient interface {
	...
	//*
	//ResolveHoldForward enables the caller to resolve a previously hold forward.
	//The caller can choose either to:
	//- `Resume`: Execute the default behavior (usually forward).
	//- `Reject`: Fail the htlc backwards.
	//- `Settle`: Settle this htlc with a given preimage.
	ResolveHoldForward(ctx context.Context, in *ResolveHoldForwardRequest, opts ...grpc.CallOption) (*ResolveHoldForwardResponse, error)
}
...
func (c *routerClient) HtlcInterceptor(ctx context.Context, opts ...grpc.CallOption) (Router_HtlcInterceptorClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Router_serviceDesc.Streams[3], "/routerrpc.Router/HtlcInterceptor", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routerClient) ResolveHoldForward(ctx context.Context, in *ResolveHoldForwardRequest, opts ...grpc.CallOption) (*ResolveHoldForwardResponse, error) {
	out := new(ResolveHoldForwardResponse)
	err := c.cc.Invoke(ctx, "/routerrpc.Router/ResolveHoldForward", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RouterServer interface {
	...
	//- `Reject`: Fail the htlc backwards.
	//- `Settle`: Settle this htlc with a given preimage.
	ResolveHoldForward(context.Context, *ResolveHoldForwardRequest) (*ResolveHoldForwardResponse, error)
}
...
func _Router_ResolveHoldForward_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResolveHoldForwardRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RouterServer).ResolveHoldForward(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/routerrpc.Router/ResolveHoldForward",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouterServer).ResolveHoldForward(ctx, req.(*ResolveHoldForwardRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Router_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ResolveHoldForward",
			Handler:    _Router_ResolveHoldForward_Handler,
		},
	},

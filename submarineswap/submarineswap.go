...
// RefundTx
func RefundTx(db *channeldb.DB, net *chaincfg.Params, wallet *lnwallet.LightningWallet, address, refundAddress btcutil.Address, feePerKw chainfee.SatPerKWeight) (*wire.MsgTx, btcutil.Amount, error) {
